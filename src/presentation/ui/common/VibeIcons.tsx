...
export type VibeIconName = 
  | 'Move' | 'Rotate' | 'Scale' | 'Minus' | 'Play' | 'Pause' | 'Square' | 'Stop'
  | 'Grid' | 'List' | 'Axis' | 'Maximize' | 'Sparkles' | 'Code' | 'Save'
  | 'Folder' | 'FolderPlus' | 'File' | 'Image' | 'Box' | 'Music' | 'Search' | 'Trash'
  | 'Upload' | 'Download' | 'Settings' | 'ChevronRight' | 'ChevronDown' | 'ChevronUp'
  | 'Home' | 'Copy' | 'Plus' | 'Loader' | 'Database' | 'Layers' | 'Activity' | 'Cursor'
...
const IconRegistry: Record<VibeIconName, React.ReactNode> = {
    ...
    Scale: <><path d="M21 16V5a2 2 0 0 0-2-2H8" /><path d="M3 8v11a2 2 0 0 0 2 2h11" /><path d="m21 3-9 9" /><path d="M15 12H9v6" /></>,
    ...
    Axis: <><path d="M21 21H3V3" /><path d="m7 14 14-7" /><path d="m21 21-7-14" /></>,
    ...
    RefreshCw: <><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8" /><polyline points="21 3 21 8 16 8" /><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16" /><polyline points="3 21 3 16 8 16" /></>,
    ...
    FolderPlus: <><path d="M12 10v6" /><path d="M9 13h6" /><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" /></>,
    ...
    Magnet: <><path d="M6 10V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v6" /><path d="M6 14a2 2 0 1 1-4 0V7a2 2 0 0 1 2-2h2" /><path d="M14 5h2a2 2 0 0 1 2 2v7a2 2 0 1 1-4 0" /></>,
    ...
    Package: <><path d="m7.5 4.21 4.5 2.6 4.5-2.6m-9 1.56v5.19l4.5 2.6 4.5-2.6v-5.19c0-.28-.15-.53-.41-.67l-3.69-2.13a.88.88 0 0 0-.8 0l-3.69 2.13a.77.77 0 0 0-.41.67Z" /><line x1="3.27" y1="6.96" x2="12" y2="12.01" /><line x1="20.73" y1="6.96" x2="12" y2="12.01" /><line x1="12" y1="22.08" x2="12" y2="12" /></>,
    Send: <><line x1="22" y1="2" x2="11" y2="13" /><polygon points="22 2 15 22 11 13 2 9 22 2" /></>,
    Bot: <><rect x="3" y="11" width="18" height="10" rx="2" /><circle cx="12" cy="5" r="2" /><path d="M12 7v4" /><line x1="8" y1="16" x2="8" y2="16" /><line x1="16" y1="16" x2="16" y2="16" /></>,
    User: <><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></>,
    Wand: <><path d="m2 22 5-5" /><path d="M9.5 14.5 14.5 9.5" /><path d="m15 2 5 2" /><path d="m2 5 2 5" /><path d="m19 19 2 5" /><path d="m5 19-5 2" /><path d="M19 2 22 5" /><path d="M8 2v1" /><path d="M15 2v1" /><path d="M21 8h1" /><path d="M21 15h1" /><path d="M12 21v1" /><path d="M5 21v1" /><path d="M2 15h1" /><path d="M2 8h1" /></>,
    ...
    RefreshCcw: <><path d="M1 4v6h6" /><path d="M23 20v-6h-6" /><path d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10m22 4l-4.64 4.36A9 9 0 0 1 3.51 15" /></>,
...
export const VibeIcons: React.FC<VibeIconsProps> = ({ 
    name, size = 18, color = 'currentColor', strokeWidth = 2, style, ...props 
}) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24"
        fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round"
        strokeLinejoin="round" style={style} {...props}>
        {IconRegistry[name] || null}
    </svg>
);